...
public class NetworkingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NetworkingPackage.SERVICE_PORT: {
				ServicePort servicePort = (ServicePort)theEObject;
				T result = caseServicePort(servicePort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkingPackage.INGRESS: {
				Ingress ingress = (Ingress)theEObject;
				T result = caseIngress(ingress);
				if (result == null) result = caseResource(ingress);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkingPackage.INGRESS_RULE: {
				IngressRule ingressRule = (IngressRule)theEObject;
				T result = caseIngressRule(ingressRule);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NetworkingPackage.HTTP_INGRESS_PATH: {
				HTTPIngressPath httpIngressPath = (HTTPIngressPath)theEObject;
				T result = caseHTTPIngressPath(httpIngressPath);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>HTTP Ingress Path</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>HTTP Ingress Path</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHTTPIngressPath(HTTPIngressPath object) {
		return null;
	}
