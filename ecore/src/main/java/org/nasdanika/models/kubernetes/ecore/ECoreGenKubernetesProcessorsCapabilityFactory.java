...
public class ECoreGenKubernetesProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenKubernetesProcessorsFactory(requirement.requirement().context()))));
	}
