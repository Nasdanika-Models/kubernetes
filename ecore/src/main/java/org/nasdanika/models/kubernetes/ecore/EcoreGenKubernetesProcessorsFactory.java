package org.nasdanika.models.kubernetes.ecore;
...
@EPackageNodeProcessorFactory(nsURI = KubernetesPackage.eNS_URI)
public class EcoreGenKubernetesProcessorsFactory {
		...
		return new EPackageNodeProcessor(config, context, prototypeProvider) {
			...
			protected void generateDiagramAndGraphActions(Collection<Label> labels, ProgressMonitor progressMonitor) {
				...
				try {
					...
					Files.writeString(new File("target/kubernetes.drawio").toPath(), document.save(null));
				} catch (Exception e) {
					e.printStackTrace();
