...
import org.nasdanika.models.kubernetes.ecore.EcoreGenKubernetesProcessorsFactory;
 ...
 *
 */
public class TestKubernetesModelDocGen {
	
	@Test
	public void testGenerateKubernetesModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenKubernetesProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenKubernetesProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "kubernetes.xmi");
		...
		String siteMapDomain = "https://kubernetes.models.nasdanika.org";		
